...
function SiaeMap( options )
{
	...
	/*
	var slippymap = new L.TileLayer(
		'../slippymap/tiles/{z}/{x}/{y}.png',
		{
			minZoom: 1, 
			maxZoom: 18, 
			attribution: 'Map data © <a href="http://www.openstreetmap.org/copyright">OpenStreetMap contributors</a>, Map by <a href="http://wiki.openstreetmap.org/wiki/JTileDownloader">JTileDownloader</a>'
	});
	this.map.addLayer(slippymap);
	*/
