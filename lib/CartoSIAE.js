...
function CartoSIAE(options)
{
	...
	this._makeSiaeTree = function()
	{
		...
		{
			if( rome.constructor === Array )
			{
				rome.forEach(function(rome){
		...
		.on('cartosiae.node_deselected', function( siaeTree, rome )
		{
		...
		.on('cartosiae.all_nodes_selected', function( siaeTree, rome )
		{
